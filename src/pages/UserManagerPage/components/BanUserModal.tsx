      ...
      <DialogContent className="sm:max-w-106.25">
        <DialogHeader>
          <div className="flex items-center gap-3 mb-2">
            <div className={`p-2 rounded-full ${isCurrentlyBanned ? 'bg-emerald-100 text-emerald-600' : 'bg-rose-100 text-rose-600'}`}>
              {isCurrentlyBanned ? <CheckCircle className="h-5 w-5" /> : <Ban className="h-5 w-5" />}
            </div>
