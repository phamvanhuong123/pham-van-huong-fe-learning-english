  ...
  return (
    <Card className="col-span-4 lg:col-span-4 border shadow-sm bg-card rounded-xl overflow-hidden">
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">Biểu đồ thể hiện lượng người dùng và lượt làm bài thi mới.</p>
      </CardHeader>
        ...
        <div className="h-[350px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="exams" name="Lượt làm bài" stroke="#6366f1" strokeWidth={3} fillOpacity={1} fill="url(#colorExams)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </CardContent>
