    ...
    <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-4 border border-indigo-100/50 text-sm shadow-sm transition-all">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Badge
            variant="outline"
            className="bg-indigo-100 text-indigo-700 border-indigo-200 text-[10px] px-1.5 py-0"
          >
            BETA
          </Badge>
        </div>
      ...
      <div className="bg-white/70 rounded-md border border-indigo-100 overflow-hidden">
        ...
        {status === 'idle' && (
          <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
            <p className="text-indigo-900/70 mb-4">
              AI sẽ phân tích chi tiết câu hỏi này, giải thích từng đáp án và cung cấp mẹo làm bài
              cho bạn.
            </p>
            <Button
        ...
        {status === 'done' && (
          <div className="flex flex-col">
            <div
              className="p-5 text-gray-800 prose prose-sm prose-indigo max-w-none 
              ...
              {followUpAnswers.length > 0 && (
                <div className="space-y-5 mb-5">
                  {followUpAnswers.map((item, idx) => (
                    <div
                      key={idx}
                      className="flex flex-col space-y-3 text-sm animate-in fade-in slide-in-from-bottom-2 duration-300"
                    >
                      {/* User Bubble */}
