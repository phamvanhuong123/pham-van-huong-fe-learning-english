      ...
      <div className="container mx-auto px-4 max-w-5xl">
                      ...
                      <TableRow key={record.id} className="hover:bg-blue-50/30 transition-colors">
                        ...
                        <TableCell className="text-center">
                          {record.isFullTest ? (
                            ...
                            <span className="font-semibold text-gray-700">{record.correctQ}/{record.totalQ}</span>
                          )}
                        </TableCell>
        ...
        {totalPages > 1 && (
          <div className="flex justify-center mt-6 gap-2">
            ...
            <Button variant="outline" disabled={page === totalPages} onClick={() => setPage(p => p + 1)}>Trang sau</Button>
          </div>
        )}
      </div>
    </div>
