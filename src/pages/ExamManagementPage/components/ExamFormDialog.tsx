...
export function ExamFormDialog({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <SheetContent className="!w-full sm:!w-[600px] sm:!max-w-[600px] flex flex-col p-0 gap-0 border-l shadow-2xl overflow-hidden">
        ...
        <SheetFooter className="px-4 sm:px-6 py-4 sm:py-5 border-t bg-muted/10 flex-shrink-0 flex gap-2">
