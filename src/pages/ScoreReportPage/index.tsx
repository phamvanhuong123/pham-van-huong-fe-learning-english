      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            {exam?.title || currentResult.grammarTopic?.name || 'Đề thi TOEIC'}
          </h1>
          <div className="text-gray-500 flex items-center gap-4 flex-wrap">
            ...
            <span className="flex items-center gap-1">
              <CheckCircle className="w-4 h-4" /> {correctQ}/{totalQ} câu đúng
            </span>
            {tabSwitchCount > 0 && (
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card className="border-gray-100 shadow-sm bg-white overflow-hidden relative pt-6">
              ...
              <CardContent className="flex flex-col items-center pb-8">
                <ScoreCircle
                  score={score}
                  maxScore={isFullTest ? 990 : totalQ * 5}
              ...
              <Card className="border-orange-100 shadow-sm bg-orange-50/50">
                ...
                <CardContent>
                  <p className="text-sm text-orange-800 mb-3">
                    Tỷ lệ đúng của bạn dưới 70% ở các phần sau:
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {weakPoints.map((wp) => (
                      <span
                        key={wp}
                        className="px-2 py-1 bg-orange-100 text-orange-700 text-xs font-bold rounded-md"
                      >
              ...
              <CardContent>
                {partBreakdown && Object.keys(partBreakdown).length > 0 ? (
                  ...
                  <div className="text-center py-10 text-gray-400">
                    Không có dữ liệu phân tích chi tiết.
                  </div>
                )}
              </CardContent>
            </Card>
