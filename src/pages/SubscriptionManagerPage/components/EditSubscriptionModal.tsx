...
export default function EditSubscriptionModal({ isOpen, onClose, subscription }: { isOpen: boolean; onClose: () => void; subscription: any }) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSave} disabled={isPending}>Lưu thay đổi</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
