...
function formatInterval(targetDate: string): string {
  ...
  const diffMonths = Math.round(diffDays / 30.44); // Trung bình 1 tháng có 30.44 ngày
...
export default function FlashcardRating({ onRate, disabled, previewIntervals }: FlashcardRatingProps) {
  return (
