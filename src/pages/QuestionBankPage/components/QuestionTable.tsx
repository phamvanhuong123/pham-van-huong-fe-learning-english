        ...
        <Table>
          <TableHeader className="bg-muted/80 backdrop-blur-sm sticky top-0 z-10 border-b border-border shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
            <TableRow className="hover:bg-transparent border-none">
              ...
              <TableHead className="min-w-[300px] h-12 font-semibold text-foreground">
                Nội dung
              </TableHead>
                    ...
                    <TableCell className="py-4">
                      <div className="max-w-[400px]">
                        ...
                        <p
                          ...
                          title={q.questionText || 'Câu hỏi không có text (Part 1/2)'}
                        >
                          {q.questionText || (
                            <span className="italic text-muted-foreground">
                              Không có văn bản câu hỏi
                            </span>
                          )}
                        </p>
                      </div>
                    ...
                    <TableCell className="py-4">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-40">
                          <DropdownMenuItem
                            onClick={() =>
                              onEdit(q.passageGroupId ? q.passageGroup : q, !!q.passageGroupId)
                            }
                          ...
                          <DropdownMenuItem
                            onClick={() =>
                              onDelete(q.passageGroupId ? q.passageGroup : q, !!q.passageGroupId)
                            }
              ...
              if (item.type === 'GROUP') {
                ...
                return (
                  <React.Fragment key={item.id}>
                    {/* Group Header Row */}
                    <TableRow
                      className="bg-muted/30 hover:bg-muted/50 cursor-pointer border-b border-border/50"
                        ...
                        >
                          ...
                          <TableCell className="py-2">
                            <p className="text-xs text-muted-foreground truncate max-w-[400px]">
                              {q.questionText || (
                                <span className="italic">Không có văn bản câu hỏi</span>
                              )}
                            </p>
                          </TableCell>
                          ...
                          <TableCell className="py-2">
                            {q.difficulty === 'EASY' ? (
                              <Badge
                                variant="outline"
                                className="bg-emerald-500/5 text-emerald-600 border-emerald-500/20 px-1.5 py-0 text-[9px] uppercase"
                              >
                                Dễ
                              </Badge>
                            ) : q.difficulty === 'MEDIUM' ? (
                              <Badge
                                variant="outline"
                                className="bg-amber-500/5 text-amber-600 border-amber-500/20 px-1.5 py-0 text-[9px] uppercase"
                              >
                                Vừa
                              </Badge>
                            ) : (
                              <Badge
                                variant="outline"
                                className="bg-rose-500/5 text-rose-600 border-rose-500/20 px-1.5 py-0 text-[9px] uppercase"
                              >
                                Khó
                              </Badge>
                            )}
