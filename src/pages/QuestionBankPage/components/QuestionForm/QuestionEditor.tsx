  ...
  const addQuestion = () => {
    ...
    setQuestions([
      ...questions,
      {
        ...
        explanation: '',
        options: JSON.parse(
          JSON.stringify(part === 'PART2' ? DEFAULT_OPTIONS.slice(0, 3) : DEFAULT_OPTIONS)
        ),
      },
    ])
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6">
        {questions.map((q, qIdx) => (
          <div
            key={qIdx}
            className="p-5 rounded-lg border bg-card/50 shadow-sm space-y-6 relative group"
          >
                  ...
                  <Label>
                    ...
                    {part === 'PART2' && (
                      <span className="text-muted-foreground font-normal text-xs">
                        (Transcript dùng để hiển thị khi Xem lại bài)
                      </span>
                    )}
                  </Label>
                  <Input
                  ...
                  <div className="flex-1 pr-8">
                    <Input
                      ...
                      className={cn(
                        ...
                        opt.isCorrect
                          ? 'text-emerald-700 dark:text-emerald-400 font-medium placeholder:text-emerald-700/50'
                          : ''
                      )}
                    />
                  </div>
