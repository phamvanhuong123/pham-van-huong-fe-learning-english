    ...
    <div className="min-h-[calc(100vh-4rem)] bg-zinc-50 dark:bg-zinc-950 py-12 px-4 md:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          >
            Nâng cấp <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-primary">TOEIC Master VIP</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Mở khóa toàn bộ kho đề thi độc quyền, lộ trình học cá nhân hóa và tính năng Flashcard SM-2 nâng cao.
          </motion.p>
        </div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <PlanCard 
                  ...
                  price={49000}
                  months={1}
                  features={['Truy cập toàn bộ đề thi Part 1-7', 'Luyện tập ngữ pháp VIP', 'Hệ thống Flashcard thông minh']}
                ...
                <PlanCard 
                  ...
                  months={3}
                  isPopular
                  features={['Mọi quyền lợi của gói 1 Tháng', 'Ưu tiên hỗ trợ từ Mentor', 'Lộ trình cá nhân hóa', 'Bảo lưu khóa học 1 lần']}
                ...
                <PlanCard 
                  ...
                  months={6}
                  features={['Mọi quyền lợi của gói 3 Tháng', 'Tặng bộ sách TOEIC PDF', 'Bảo lưu khóa học 2 lần']}
          ...
          {step === 'SUCCESS' && (
            ...
            >
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Hóa đơn của bạn đã được gửi tới hệ thống. Chúng tôi sẽ kiểm tra và kích hoạt gói VIP cho bạn trong vòng tối đa <span className="font-semibold text-foreground">24 giờ</span> làm việc.
              </p>
