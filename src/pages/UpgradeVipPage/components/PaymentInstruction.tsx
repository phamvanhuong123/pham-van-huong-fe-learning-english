    ...
    >
      ...
      <div className="flex-1 w-full space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <DetailRow label="Ngân hàng" value={bankDetails.bankName} />
          <DetailRow label="Chủ tài khoản" value={bankDetails.accountName} />
          <DetailRow label="Số tài khoản" value={bankDetails.accountNo} canCopy />
          <DetailRow
            label="Số tiền"
        ...
        <div className="flex items-start gap-2 text-sm text-amber-600 bg-amber-50 p-3 rounded-lg border border-amber-200/50">
          ...
          <p>
            Vui lòng ghi đúng nội dung chuyển khoản để hệ thống duyệt tự động nhanh nhất. Nếu quên,
            bạn sẽ cần chờ Admin duyệt thủ công (tối đa 24h).
          </p>
        </div>
      </div>
    </motion.div>
